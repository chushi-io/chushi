...
ActiveRecord::Schema[7.1].define(version: 20_241_012_005_924) do
  ...
  create_table 'access_tokens', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[token_authable_type token_authable_id], name: 'index_access_tokens_on_token_authable'
  end
  ...
  create_table 'agent_pools', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_agent_pools_on_organization_id_and_name', unique: true
  ...
  create_table 'notification_configurations', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[workspace_id name], name: 'index_notification_configurations_on_workspace_id_and_name', unique: true
    t.index %w[workspace_id url], name: 'index_notification_configurations_on_workspace_id_and_url', unique: true
  ...
  create_table 'oauth_access_grants', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[resource_owner_id resource_owner_type], name: 'polymorphic_owner_oauth_access_grants'
  ...
  create_table 'oauth_access_tokens', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[resource_owner_id resource_owner_type], name: 'polymorphic_owner_oauth_access_tokens'
  ...
  create_table 'organization_memberships', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id email], name: 'index_organization_memberships_on_organization_id_and_email',
                                       unique: true
    t.index %w[organization_id user_id], name: 'index_organization_memberships_on_organization_id_and_user_id',
                                         unique: true
  ...
  create_table 'policies', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_policies_on_organization_id_and_name', unique: true
  ...
  create_table 'policy_sets', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_policy_sets_on_organization_id_and_name', unique: true
  ...
  create_table 'projects', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_projects_on_organization_id_and_name', unique: true
  ...
  create_table 'provider_versions', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[provider_id version], name: 'index_provider_versions_on_provider_id_and_version', unique: true
  ...
  create_table 'registry_module_versions', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[registry_module_id version], name: 'idx_on_registry_module_id_version_b4b67eee77', unique: true
  ...
  create_table 'registry_modules', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[namespace name provider], name: 'index_registry_modules_on_namespace_and_name_and_provider',
                                         unique: true
  ...
  create_table 'run_triggers', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[workspace_id sourceable_id], name: 'index_run_triggers_on_workspace_id_and_sourceable_id',
                                            unique: true
  ...
  create_table 'ssh_keys', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_ssh_keys_on_organization_id_and_name', unique: true
  ...
  create_table 'taggings', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[tagger_type tagger_id], name: 'index_taggings_on_tagger'
  ...
  create_table 'teams', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_teams_on_organization_id_and_name', unique: true
  ...
  create_table 'vcs_connections', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_vcs_connections_on_organization_id_and_name'
  ...
  create_table 'workspace_policy_sets', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[workspace_id policy_set_id], name: 'index_workspace_policy_sets_on_workspace_id_and_policy_set_id',
                                            unique: true
  ...
  create_table 'workspace_tasks', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[workspace_id run_task_id], name: 'index_workspace_tasks_on_workspace_id_and_run_task_id', unique: true
  ...
  create_table 'workspace_teams', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[workspace_id team_id], name: 'index_workspace_teams_on_workspace_id_and_team_id', unique: true
  ...
  create_table 'workspaces', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[organization_id name], name: 'index_workspaces_on_organization_id_and_name', unique: true
