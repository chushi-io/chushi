...
replace github.com/hashicorp/terraform-exec => github.com/opentofu/tofu-exec v0.0.0-20231211200946-e5963f176ec5
...
require (
	...
	github.com/lileio/pubsub v0.0.0-20190923214451-d1c628de58cb // indirect
