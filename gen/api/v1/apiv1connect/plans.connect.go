...
var (
	plansServiceDescriptor          = v1.File_api_v1_plans_proto.Services().ByName("Plans")
...
// NewPlansClient constructs a client for the api.v1.Plans service. By default, it uses the Connect
...
// UploadPlan calls api.v1.Plans.UploadPlan.
...
func NewPlansHandler(svc PlansHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/api.v1.Plans/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPlansHandler) UploadPlan(context.Context, *connect.Request[v1.UploadPlanRequest]) (*connect.Response[v1.UploadPlanResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("api.v1.Plans.UploadPlan is not implemented"))
}
